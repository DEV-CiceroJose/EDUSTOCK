...
após o carregamento da página. Ele é o componente que permite ao navegador
tratar o site como uma PWA e manter os arquivos essenciais da interface em
cache.
...
- suíte de testes do app Alunos: **13 testes aprovados**;
- suíte de testes do app Cozinha: **13 testes aprovados**.
