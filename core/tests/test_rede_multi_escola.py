...
class RedeMultiEscolaTest(TestCase):
    ...
    def test_modelo_municipal_vira_receita_editavel_na_escola(self):
        ...
        ingrediente = receita.ingredientes.get()
        self.assertEqual(ingrediente.produto.escola_id, self.escola_b.pk)
        self.assertEqual(ingrediente.produto.unidade_consumo, "G")
        self.assertEqual(ingrediente.produto.conteudo_por_unidade, Decimal("1000"))
        self.assertEqual(ingrediente.quantidade_por_aluno, Decimal("35"))
