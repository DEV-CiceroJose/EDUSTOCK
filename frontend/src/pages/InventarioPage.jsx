...
export default function InventarioPage() {
  ...
  return (
    <div className="mx-auto w-full max-w-[1500px] px-6 py-8">
      ...
      {canManage && <ProductFormModal open={addOpen || addRequested || !!editProduto} produto={editProduto} grupos={grupos} fornecedores={fornecedores.filter(f => f.ativo)} onClose={fecharFormProduto} onSaved={carregar} />}
