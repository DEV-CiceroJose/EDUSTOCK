...
export const Icon = {
  ...
  check: (s = 18) => (<svg {...base(s)}><path d="m5 12 4 4L19 6" /></svg>),
  clock: (s = 18) => (<svg {...base(s)}><circle cx="12" cy="12" r="9" /><path d="M12 7v5l3 2" /></svg>),
  chart: (s = 18) => (<svg {...base(s)}><path d="M4 20V10M10 20V4M16 20v-7M22 20V7" /></svg>),
  activity: (s = 18) => (<svg {...base(s)}><path d="M3 12h4l2-7 4 14 2-7h6" /></svg>),
  // Categorias
